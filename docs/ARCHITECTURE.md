...
#1 Wei Ming       1,840 pts  🏆 Kiasu Champion
#2 Ahmad          1,620 pts  📈 Most Improved
#3 Priya          1,480 pts  🍱 Healthy Kaki
...
> `home_location` coordinates derived from neighbourhood centroids: Wei Ming → Yishun (`[103.827, 1.422]`), Ahmad → Ang Mo Kio (`[103.820, 1.365]`), Priya → Tampines (`[103.943, 1.353]`), Siti → Jurong West (`[103.740, 1.345]`). Wei Ming's run metrics are calibrated against real Apple Health GPX data (Yishun area, ~4:30/km pace, ~5 km sessions).

### 7-Day Metrics (Mon 9 Mar – Sun 15 Mar 2026)

| Date       | Ahmad steps | Ahmad meal | Priya steps | Priya meal | Wei Ming steps | Wei Ming meal | Siti steps | Siti meal |
|------------|-------------|------------|-----------|----------|-------------|------------|-------------|------------|
...
> Run time (minutes) mock: Ahmad 45, Priya 30, Wei Ming 60, Siti 20

Expected standings after ES|QL (approximate, before age adjustment):
1. Wei Ming — most consistent steps + high meal scores
2. Ahmad — good steps, solid meal
3. Priya — variable steps, solid meal
