...
4 seed players: Chris (35, league `sg-league-001`), Komal (42), Nick (28), Gaby (51). Include 7 days of mock `WeeklyMetric` records per player with step counts, meal scores, and activity flags. Export:
